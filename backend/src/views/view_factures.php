...
<body>
    ...
    <main class="container my-4">
        ...
        <form method="get" class="row mb-5 mt-5 bg-dark-subtle shadow gap-3 p-3">
            ...
            <input type="hidden" name="route" value="factures">

            <div class="col-md-3">
                <label for="avance_status"><b>Par type :</b></label>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button
                                        ...
                                        data-id="<?php echo $row['id'] ?>">Voir détails
                                    </button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                            ...
                            <div class="modal-body">
                                    ...
                                    <div class="d-flex justify-content-end mb-3 gap-1">
                                        <div class="col-6 d-flex flex-column">
                                            <div class="row d-flex bg-primary">
                                                <div class="col-6 d-flex justify-content-center text-white p-1">
                                                    <h6>N° FACTURE</h6>
                                                </div>
                                                <div class="col-6 d-flex justify-content-center text-white p-1">
                                                    <h6>DATE</h6>
                                    ...
                                    <div class="d-flex justify-content-between mb-3 gap-1">
                                        <div class="col-5 d-flex flex-column">
                                            <div class=" bg-primary">
                                                <div class="d-flex justify-content-center text-white p-1">
                                                    <h6>FACTURE A</h6>
                                                </div>
                                            </div>
                                            <?php if (empty($datasTablesSuppliers)): ?>
                                ...
                                <div class="d-flex flex-column gap-2 p-2">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <h6>Montant Total TTC :
                                            <?php echo htmlspecialchars($row['amount_ttc']); ?> XAF</h6>
                                    </div>
                                </div>
                            </div>
