<?php
    ...
    $validCategories = [
        'fournitures', 'équipement', 'services', 'maintenance',
        'logistique', 'électricité', 'plomberie', 'chauffage',
        'climatisation', 'ventilation', 'sécurité', 'informatique',
        'bureautique', 'matériel de chantier', 'outillage',
