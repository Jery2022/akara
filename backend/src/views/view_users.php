    ...
    <div class="modal-dialog">
     <form method="post" class="modal-content" id="addUserForm">
        ...
        <div class="modal-body">
            ...
            <div id="employeeFieldsAdd" class="needs-validation"> <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select name="statut" id="add-statut" class="form-select" required>
                    ...
                    <option value="desactive">Désactivé</option> </select>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <form method="post" class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="employeeFieldsEdit" class="needs-validation"> <div class="mb-3">
