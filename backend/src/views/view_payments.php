...
$validSortColumns = ['id', 'contrat_id', 'user_id', 'customer_id', 'amount', 'customer_name', 'employee_name', 'category', 'contrat_name'];
...
} elseif ($sortBy === 'contrat_name') {
    $query .= " ORDER BY co.name $order";
} else {
                    ...
                    <?php else: ?>
                        ...
                        foreach ($payments as $row): ?>
                            <tr>
                                ...
                                <td data-label="Reçu par"><?php echo htmlspecialchars($row['employee_name'] ?? 'N/A') ?></td>
