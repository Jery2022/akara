...
<?php foreach ($factures as $row): ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($row['amount_total']) ?></td>
                    <td><?php echo htmlspecialchars($row['amount_tva']) ?></td>
                    <td><?php echo htmlspecialchars($row['amount_css']) ?></td>
                    <td><?php echo htmlspecialchars($row['amount_ttc']) ?></td>
                    <td><?php echo htmlspecialchars($row['avance_status'] ?? '') ?></td>
...
<?php foreach ($detailsFactures as $details): ?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlspecialchars($details['produit_id']) ?></td>
                                            <td><?php echo htmlspecialchars($details['quantity']) ?></td>
                                            <td><?php echo htmlspecialchars($details['price_unit']) ?></td>
                                            <td><?php echo htmlspecialchars($details['amount']) ?></td>
                                            <td><?php echo htmlspecialchars($details['amount_tva']) ?></td>
                                        </tr>
                                        <?php endforeach; ?>
<?php endif; ?>
                                </tbody>
