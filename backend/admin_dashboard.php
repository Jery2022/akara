<?php
    ...
    $payments = getMonthlyDepenses();

    $labels = ['Jan', 'Fév', 'Mar', 'Avr', 'Mai', 'Juin', 'Juil', 'Août', 'Sep', 'Oct', 'Nov', 'Déc'];

    // Créons deux tableaux avec 12 mois initialisés à 0
    ...
    foreach ($payments as $p) {
        ...
        $paymentData[$mois] = (float) $p['total'];
    }
  ...
  <div class="main-content">
    <div class="titre bg-primary shadow-sm rounded mb-4">
      <div class="container-fluid">
        <span class="navbar-brand"><h3>Tableau de bord Administration</h3></span>
      </div>
    </div>
      ...
      <div class="col-md-3">
        <div class="card border-0 shadow-sm text-white bg-gradient-danger animate__animated animate__fadeInUp">
          <div class="card-body">
            ...
            <h4 class="card-title"><?php echo getDepensesTotal(); ?> €</h4>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-3">
        <div class="card border-0 shadow-sm text-white bg-gradient-orange animate__animated animate__fadeInUp">
          <div class="card-body">
            ...
            <h4 class="card-title"><?php echo getAchatsTotal(); ?> €</h4>
          </div>
        </div>
      </div>
    </div>
