    ...
    <div className="min-h-screen bg-gray-100 p-4 font-sans antialiased">
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        {filteredContrats.length === 0 ? (
          <p className="text-center text-gray-500">Aucun contrat trouvé.</p>
        ) : (
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white rounded-md overflow-hidden">
              <thead className="bg-gray-200">
                <tr>
                  <th className="py-3 px-6 text-left text-sm font-medium text-gray-600 uppercase tracking-wider">Réf</th>
                  <th className="py-3 px-6 text-left text-sm font-medium text-gray-600 uppercase tracking-wider">Objet</th>
                  <th className="py-3 px-6 text-left text-sm font-medium text-gray-600 uppercase tracking-wider">Date début</th>
                  <th className="py-3 px-6 text-left text-sm font-medium text-gray-600 uppercase tracking-wider">Date fin</th>
              ...
              <tbody className="divide-y divide-gray-200">
                {filteredContrats.map((contrat) => (
                  <tr key={contrat.id} className="hover:bg-gray-50 transition-colors duration-150">
                    <td className="py-4 px-6 whitespace-nowrap text-sm font-medium text-gray-900">{contrat.ref}</td>
                    <td className="py-4 px-6 whitespace-nowrap text-sm text-gray-600">{contrat.objet}</td>
                    <td className="py-4 px-6 whitespace-nowrap text-sm text-gray-600">{contrat.date_debut}</td>
                    <td className="py-4 px-6 whitespace-nowrap text-sm text-gray-600">{contrat.date_fin}</td>
                    <td className="py-4 px-6 whitespace-nowrap text-sm text-gray-600">{contrat.type}</td>
                    <td className="py-4 px-6 whitespace-nowrap text-sm text-gray-600">{contrat.status}</td>
