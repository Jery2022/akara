...
function CreateRecetteModal({ onClose, onSave, produits, customers, contrats, errorMessage, onClearBackendError }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formState.produit_id || !formState.customer_id) {
        setValidationError('Veuillez sélectionner un produit et un client.');
        return;
    }
