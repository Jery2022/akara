...
// Composant pour la modale de modification d'une dépense
const EditDepenseModal = ({ onClose, onSave, depenseToEdit }) => {
  ...
  const handleSubmit = (e) => {
    ...
    // Appel à la fonction de sauvegarde passée en prop avec les données mises à jour
    onSave(formData);
    onClose();
  };
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-lg w-full h-[500px] flex flex-col overflow-hidden">
        <h3 className="text-lg font-semibold text-white bg-emerald-600 p-4 shadow-md">Modifier la dépense</h3>
        <div className="flex-grow overflow-y-auto p-6">
          <MessageDisplay message={message} onClose={closeMessage} />
          <form id="editDepenseForm" onSubmit={handleSubmit} className="space-y-4">
            <div>
