// frontend/src/components/utils/CreateEntrepotModal.jsx

import React, { useState } from 'react';

function CreateEntrepotModal({ onClose, onSave }) {
